        ...
        {/* <div className="flex gap-40 translate-x-[-0.1rem] translate-y-[-76.8rem]">  
                  ...
                  <div className="flex justify-center gap-7 translate-x-[9.1rem] translate-y-[-50.4rem]">
                    <div>
                        ...
                        <img style={{height: 197, width: 347, transform: "translateX(-325px)"}} src="/fbpage.png"/>
                    </div>
                    <div>
                        <h3 className="translate-x-[-13.5rem]">Line Official</h3>
                        <img style={{height: 197, width: 347, transform: "translateX(-325px)"}} src="/linet.jpg"/>  
