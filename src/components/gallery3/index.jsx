      ...
      <div className="flex-1 flex-col xl:px-0 sm:px-16 px-6"> 
        ...
        {/* <div className="flex gap-40 translate-x-[-0.1rem] translate-y-[-76.8rem]">  
                  ...
                  <div className="flex justify-center gap-7 translate-x-[9.1rem] translate-y-[-50.4rem]">
                    <img style={{height: 197, width: 347, transform: "translateX(-325px)"}} src="/ps3.jpg"/>
                    <img style={{height: 197, width: 347, transform: "translateX(-325px)"}} src="/ps2.jpg"/>  
                    <img style={{height: 197, width: 347, transform: "translateX(-325px)"}} src="/ps1.jpg"/>
